...
<%@ page import="com.hillel.javaee.model.Product" %>
...
<div style="display: inline-block;">
    <c:if test="${applicationScope.basketProducts.size()==0}">
    ...
    <c:forEach items="${applicationScope.basketProducts}" var="basketProduct">
        ...
        <form action="basket" method="post">
            <input type="hidden" name="remove" value="${basketProduct.key.id}">
...
<c:if test="${applicationScope.basketProducts.size()>0}">
    <form action="checkout" method="post" id="orderForm" onclick="checkCheckboxes()">
