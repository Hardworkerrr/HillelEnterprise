...
SELECT c.id, c.name, e.address FROM customer AS c JOIN email_address AS e ON c.id = e.customer_id WHERE c.id=3;
INSERT INTO customer VALUES (4, 'Viktor Walla', '1972-11-30');
DELETE FROM customer WHERE customer.id=5;
INSERT INTO email_address (id, customer_id, address) VALUES (5, 4, 'test@fulanito.com');
